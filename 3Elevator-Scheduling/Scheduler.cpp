...
int Scheduler::decide(Elevator& elevator) {
    int currentFloor = elevator.getCurrentFloor();
    auto insidePassengers = elevator.getInsidePassengers();
    auto triggeredPassengers = elevator.getTriggeredPassengers();
    ...
    for (auto iter = insidePassengers.begin(); iter != insidePassengers.end(); iter++) {
        int destination = (*iter).getDestinstaion();
    ...
    for (auto iter = triggeredPassengers.begin(); iter != triggeredPassengers.end(); iter++) {
        int initialFloor = (*iter).getInitialFloor();
